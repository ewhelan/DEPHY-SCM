...
## Bjorg Jenny Engdahl's supercooled liquid (orography) case
...
case.set_title("Forcing and initial conditions for SCLO orography case - Original definition")
...
case.set_script("DEPHY-SCM/ENGDAHL/SCLO/driver_DEF.py")
...
case.write(f'ENGDAHL_SCLO_DEF_driver.nc')
